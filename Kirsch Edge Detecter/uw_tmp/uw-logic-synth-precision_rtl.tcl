...
foreach file [concat {  } { util.vhd mem.vhd kirsch_synth_pkg.vhd syn_fifo.vhd kirsch.vhd components.vhd kirsch_top.vhd }] {
  add_input_file $file
}  

compile

auto_write uw_tmp/kirsch_top_gate.vhd
...
# generates uw_tmp/kirsch_top_logic.v, .vhd
synthesize
...
auto_write uw_tmp/kirsch_top_logic.sdf

report_constraints \
  -hierarchy \
  -clocks \
  uw_tmp/kirsch_top_logic.sdc
